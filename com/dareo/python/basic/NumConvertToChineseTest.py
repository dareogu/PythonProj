...
@: Dareo_Gu
'''
dict_num = {"0": u"零", "1": u"壹", "2": u"贰", "3": u"叁", "4": u"肆", "5": u"伍", "6": u"陆", "7": u"柒", "8": u"捌",
            "9": u"玖"}
...
while flag:
    ...
    if num == 'q' or num == 'Q':
        ...
        numSize = len(listnum) - 1  # 如果是5位数，实际索引是从0到4的
        for item in listnum:
            fs.append(dict_num[item])
            fs.append(dict_unit[numSize])
            numSize -= 1  # 每次递减一位，就能从实现从万到仟的转换
